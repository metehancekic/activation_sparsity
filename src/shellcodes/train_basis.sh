...
--classifier_arch=$model --classifier_epochs 100 -sm true"
echo $COMMAND
eval $COMMAND

COMMAND="python -m src.attack_classifier  \
--classifier_arch=$model --classifier_epochs 100 --attack_method PGD --attack_EOT_size 1 --attack_num_steps 40 --attack_num_restarts 1"
echo $COMMAND
eval $COMMAND
